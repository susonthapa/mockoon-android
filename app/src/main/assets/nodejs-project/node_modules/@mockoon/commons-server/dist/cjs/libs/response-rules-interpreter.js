    ...
    constructor(routeResponses, request, randomResponse, sequentialResponse) {
        ...
        this.isValidRule = (rule, requestNumber) => {
            ...
            if (rule.target === 'header') {
                ...
                if (rule.modifier) {
                    value = object_path_1.get(this.targets[rule.target], rule.modifier);
                }
