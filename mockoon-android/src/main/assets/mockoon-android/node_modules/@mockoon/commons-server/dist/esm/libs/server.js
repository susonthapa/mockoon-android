import { BINARY_BODY, CORSHeaders, GetContentType, GetRouteResponseContentType, IsValidURL, MimeTypesWithTemplating, ServerErrorCodes, TestHeaderValidity } from '@mockoon/commons';
...
export class MockoonServer extends EventEmitter {
    ...
    sendFile(routeResponse, routeContentType, request, response) {
        try {
            const filePath = TemplateParser(routeResponse.filePath.replace(/\\/g, '/'), request, this.environment);
            ...
            if (!this.options.environmentDirectory) {
                ...
                processedFilePath = resolve(this.options.environmentDirectory, filePath);
            }
    ...
    enableProxy(server) {
        if (this.environment.proxyMode &&
            ...
            server.use('*', createProxyMiddleware({
                ...
                ssl: Object.assign(Object.assign({}, DefaultSSLConfig), { agent: false }),
